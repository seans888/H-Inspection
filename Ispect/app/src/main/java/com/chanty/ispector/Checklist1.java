...
/*
This is the checklist for the Suite  rooms*/
...
public class Checklist1 extends AppCompatActivity {
    ...
    private Button scan_btn, txt1btn, txt2btn, txt3btn, txt4btn, txt5btn, txt6btn, txt7btn, txt8btn, txt9btn, txt10btn, txt11btn, txt12btn, txt13btn, txt14btn,txt15btn, txt16btn, txt17btn, txt18btn, txt19btn, txt20btn, txt21btn, txt22btn, txt23btn, txt24btn, txt25btn, txt26btn, txt27btn, txt28btn, txt29btn, txt30btn
            ...
            ,txt96btn, txt97btn, txt98btn, txt99btn, txt100btn, txt101btn, txt102btn, txt103btn, txt104btn, txt105btn, txt106btn, txt107btn, txt108btn, txt109btn, txt110btn, txt111btn, txt112btn, txt113btn, txt114btn, txt115btn;
    EditText text1, text2, text3, text4, text5, text6, text7, text8, text9, text10, text11, text12, text13, text14, text15, text16, text17, text18, text19, text20, text21, text22, text23, text24,
            ...
            , text74, text75, text76, text77, text78, text79, text80, text81, text82, text83, text84, text85, text86, text87, text88, text89, text90, text91, text92, text93
            , text94, text95, text96, text97, text98, text99, text100, text101, text102, text103, text104, text105, text106, text107, text108, text109, text110, text111, text112, text113, text114, text115;
    ...
    CheckBox First, Second, Third, ch4, ch5, ch6, ch7, ch8, ch9, ch10, ch11, ch12, ch13, ch14, ch15, ch16, ch17,
            ...
            ch79, ch80, ch81, ch82, ch83, ch84, ch85, ch86, ch87, ch88, ch89, ch90,ch94, ch95, ch96, ch97, ch98, ch99, ch100, ch101, ch102, ch103,
            ch104, ch105, ch106, ch107, ch108, ch109, ch110, ch111, ch112, ch113, ch114, ch115;
    ...
    public void addListenerOnButton() {
        ...
        ch94 = (CheckBox)findViewById(R.id.ch94);

        ch95 = (CheckBox)findViewById(R.id.ch95);

        ch96 = (CheckBox)findViewById(R.id.ch96);

        ch97 = (CheckBox)findViewById(R.id.ch97);

        ch98 = (CheckBox)findViewById(R.id.ch98);

        ch99 = (CheckBox)findViewById(R.id.ch99);

        ch100 = (CheckBox)findViewById(R.id.ch100);
        ...
        ch105 = (CheckBox)findViewById(R.id.ch105);

        ch106 = (CheckBox)findViewById(R.id.ch106);

        ch107 = (CheckBox)findViewById(R.id.ch107);

        ch108 = (CheckBox)findViewById(R.id.ch108);

        ch109 = (CheckBox)findViewById(R.id.ch109);


        ch110 = (CheckBox)findViewById(R.id.ch110);
        ...
        text93 = (EditText) findViewById(R.id.text93);
        text94 = (EditText) findViewById(R.id.text94);
        text95 = (EditText) findViewById(R.id.text95);
        text96 = (EditText) findViewById(R.id.text96);
        text97 = (EditText) findViewById(R.id.text97);
        text98 = (EditText) findViewById(R.id.text98);
        text99 = (EditText) findViewById(R.id.text99);
        text100 = (EditText) findViewById(R.id.text100);
        text101 = (EditText) findViewById(R.id.text101);
        text102 = (EditText) findViewById(R.id.text102);
        text103 = (EditText) findViewById(R.id.text103);
        text104 = (EditText) findViewById(R.id.text104);
        text105 = (EditText) findViewById(R.id.text105);
        text106= (EditText) findViewById(R.id.text106);
        text107 = (EditText) findViewById(R.id.text107);
        text108 = (EditText) findViewById(R.id.text108);
        text109 = (EditText) findViewById(R.id.text109);
        text110 = (EditText) findViewById(R.id.text110);
...
//THIS GETS THE TEXT VALUE OF THE TITLE/TEXT OF THE CHECKBOXES
                ...
                String param94 = ch94.getText().toString().trim();
                String param95 = ch95.getText().toString().trim();
                String param96 = ch96.getText().toString().trim();
                String param97 = ch97.getText().toString().trim();
                String param98 = ch98.getText().toString().trim();
                String param99 = ch99.getText().toString().trim();
                String param100 = ch100.getText().toString().trim();
                String param101 = ch101.getText().toString().trim();
                String param102 = ch102.getText().toString().trim();
                String param103 = ch103.getText().toString().trim();
                String param104 = ch104.getText().toString().trim();
                String param105 = ch105.getText().toString().trim();
                String param106 = ch106.getText().toString().trim();
                String param107 = ch107.getText().toString().trim();
                String param108 = ch108.getText().toString().trim();
                String param109 = ch109.getText().toString().trim();
                String param110 = ch110.getText().toString().trim();
...
//THESE ARE THE CONDITIONS FOR THE CHECKBOX, SETTING ITS VALUE
         ...
         /*       if (ch18.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time..child("Checklistchild(param18);
                    reference.setValue("Yes");
                    String userText = text18.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time..child("Checklistchild("Remarks").child(param18);
                    reference.setValue(userText);
                ...
                if (ch94.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param94);
                    reference.setValue("Yes");
                    String userText = text94.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param94);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param94);
                ...
                if (ch95.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param95);
                    reference.setValue("Yes");
                    String userText = text95.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param95);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param95);
                ...
                if (ch96.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param96);
                    reference.setValue("Yes");
                    String userText = text96.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param96);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param96);
                ...
                if (ch97.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param97);
                    reference.setValue("Yes");
                    String userText = text97.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param97);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param97);
                ...
                if (ch98.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param98);
                    reference.setValue("Yes");
                    String userText = text98.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param98);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param98);
                ...
                if (ch99.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param99);
                    reference.setValue("Yes");
                    String userText = text99.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param99);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param99);
                ...
                if (ch100.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param100);
                    reference.setValue("Yes");
                    String userText = text100.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param100);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param100);
                ...
                if (ch101.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param101);
                    reference.setValue("Yes");
                    String userText = text101.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param101);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param101);
                ...
                if (ch102.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param102);
                    reference.setValue("Yes");
                    String userText = text102.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param102);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param102);
                ...
                if (ch103.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param103);
                    reference.setValue("Yes");
                    String userText = text103.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param103);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param103);
                ...
                if (ch104.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param104);
                    reference.setValue("Yes");
                    String userText = text104.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param104);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param104);
                ...
                if (ch105.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param105);
                    reference.setValue("Yes");
                    String userText = text105.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param105);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param105);
                ...
                if (ch106.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param106);
                    reference.setValue("Yes");
                    String userText = text106.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param106);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param106);
                ...
                if (ch107.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param107);
                    reference.setValue("Yes");
                    String userText = text107.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param107);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param107);
                ...
                if (ch108.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param108);
                    reference.setValue("Yes");
                    String userText = text108.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param108);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param108);
                ...
                if (ch109.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param109);
                    reference.setValue("Yes");
                    String userText = text109.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param109);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param109);
                ...
                if (ch110.isChecked()) {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param110);
                    reference.setValue("Yes");
                    String userText = text110.getText().toString();
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child("Remarks").child(param110);
                    reference.setValue(userText);
                } else {
                    reference = mFirebaseDatabase1.child(RoomName).child(date).child("Inspection").child("Scan-in").child("Inspector").child(newuserEmail).child(Time).child("Checklist").child(param110);
        ...
        //THIS PART IS FOR BUTTON VISIBILITY, IF THE BUTTON IS CLICKED IT BECOMES VISISBLE AND VICE VERSA
        ...
        txt94btn = (Button) findViewById(R.id.txt94btn);

        txt94btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text94.getVisibility() == View. VISIBLE){
                    text94.setVisibility(View.INVISIBLE);

                }else{
                    text94.setVisibility(View.VISIBLE);
        ...
        txt95btn = (Button) findViewById(R.id.txt95btn);

        txt95btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text95.getVisibility() == View. VISIBLE){
                    text95.setVisibility(View.INVISIBLE);

                }else{
                    text95.setVisibility(View.VISIBLE);
        ...
        txt96btn = (Button) findViewById(R.id.txt96btn);

        txt96btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text96.getVisibility() == View. VISIBLE){
                    text96.setVisibility(View.INVISIBLE);

                }else{
                    text96.setVisibility(View.VISIBLE);
        ...
        txt97btn = (Button) findViewById(R.id.txt97btn);

        txt97btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text97.getVisibility() == View. VISIBLE){
                    text97.setVisibility(View.INVISIBLE);

                }else{
                    text97.setVisibility(View.VISIBLE);
        ...
        txt98btn = (Button) findViewById(R.id.txt98btn);

        txt98btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text98.getVisibility() == View. VISIBLE){
                    text98.setVisibility(View.INVISIBLE);

                }else{
                    text98.setVisibility(View.VISIBLE);
        ...
        txt99btn = (Button) findViewById(R.id.txt99btn);

        txt99btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text99.getVisibility() == View. VISIBLE){
                    text99.setVisibility(View.INVISIBLE);

                }else{
                    text99.setVisibility(View.VISIBLE);
        ...
        txt100btn = (Button) findViewById(R.id.txt100btn);

        txt100btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text100.getVisibility() == View. VISIBLE){
                    text100.setVisibility(View.INVISIBLE);

                }else{
                    text100.setVisibility(View.VISIBLE);
        ...
        txt101btn = (Button) findViewById(R.id.txt101btn);

        txt101btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text101.getVisibility() == View. VISIBLE){
        ...
        txt102btn = (Button) findViewById(R.id.txt102btn);

        txt102btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text102.getVisibility() == View. VISIBLE){
                    text102.setVisibility(View.INVISIBLE);

                }else{
                    text102.setVisibility(View.VISIBLE);
        ...
        txt103btn = (Button) findViewById(R.id.txt103btn);

        txt103btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text103.getVisibility() == View. VISIBLE){
                    text103.setVisibility(View.INVISIBLE);

                }else{
                    text103.setVisibility(View.VISIBLE);
        ...
        txt104btn = (Button) findViewById(R.id.txt104btn);

        txt104btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text104.getVisibility() == View. VISIBLE){
                    text104.setVisibility(View.INVISIBLE);

                }else{
                    text104.setVisibility(View.VISIBLE);
        ...
        txt105btn = (Button) findViewById(R.id.txt105btn);

        txt105btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text105.getVisibility() == View. VISIBLE){
                    text105.setVisibility(View.INVISIBLE);

                }else{
                    text105.setVisibility(View.VISIBLE);
        ...
        txt106btn = (Button) findViewById(R.id.txt106btn);

        txt106btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text106.getVisibility() == View. VISIBLE){
                    text106.setVisibility(View.INVISIBLE);

                }else{
                    text106.setVisibility(View.VISIBLE);
        ...
        txt107btn = (Button) findViewById(R.id.txt107btn);

        txt107btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text107.getVisibility() == View. VISIBLE){
                    text107.setVisibility(View.INVISIBLE);

                }else{
                    text107.setVisibility(View.VISIBLE);
        ...
        txt108btn = (Button) findViewById(R.id.txt108btn);

        txt108btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text108.getVisibility() == View. VISIBLE){
                    text108.setVisibility(View.INVISIBLE);

                }else{
                    text108.setVisibility(View.VISIBLE);
        ...
        txt109btn = (Button) findViewById(R.id.txt109btn);

        txt109btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text109.getVisibility() == View. VISIBLE){
                    text109.setVisibility(View.INVISIBLE);

                }else{
                    text109.setVisibility(View.VISIBLE);
        ...
        txt110btn = (Button) findViewById(R.id.txt110btn);

        txt110btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (text110.getVisibility() == View. VISIBLE){
                    text110.setVisibility(View.INVISIBLE);

                }else{
                    text110.setVisibility(View.VISIBLE);
