...
public class ScannerParent1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scanner_parent1);
...
//ROOMS
        ...
        mFirebaseDatabase1.child("Suite Room1").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
...
//THIS PART MAKES UP THE ROOM COLORING WORKFLOW BASED ON DATABASE VALUES
        ...
        mFirebaseDatabase1.child("Suite Room2").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) { //something changed!
...
//THIS PART MAKES UP THE ROOM COLORING WORKFLOW BASED ON DATABASE VALUES
        ...
        mFirebaseDatabase1.child("Suite Room3").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) { //something changed!
...
//THIS PART MAKES UP THE ROOM COLORING WORKFLOW BASED ON DATABASE VALUES
        ...
        mFirebaseDatabase1.child("Suite Room4").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) { //something changed!
...
//THIS PART MAKES UP THE ROOM COLORING WORKFLOW BASED ON DATABASE VALUES
        ...
        mFirebaseDatabase1.child("Suite Room5").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) { //something changed!
...
//THIS PART MAKES UP THE ROOM COLORING WORKFLOW BASED ON DATABASE VALUES
        ...
        mFirebaseDatabase1.child("Suite Room6").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) { //something changed!
...
//THIS PART MAKES UP THE ROOM COLORING WORKFLOW BASED ON DATABASE VALUES
        ...
        mFirebaseDatabase1.child("Suite Room7").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) { //something changed!
...
//THIS PART MAKES UP THE ROOM COLORING WORKFLOW BASED ON DATABASE VALUES
        ...
        mFirebaseDatabase1.child("Suite Room8").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) { //something changed!
...
//THIS PART MAKES UP THE ROOM COLORING WORKFLOW BASED ON DATABASE VALUES
        ...
        mFirebaseDatabase1.child("Suite Room9").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) { //something changed!
...
//THIS PART MAKES UP THE ROOM COLORING WORKFLOW BASED ON DATABASE VALUES
        ...
        mFirebaseDatabase1.child("Suite Room10").addValueEventListener(new ValueEventListener() { //attach listener
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) { //something changed!
...
//ROOMS
    ...
    //FOR TOGGLE BAR OF THE NAVIGATION BAR
