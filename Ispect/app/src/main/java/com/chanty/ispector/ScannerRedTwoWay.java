...
//THIS IS FOR THE SCAN-IN OF THE INSPECTOR

public class ScannerRedTwoWay extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(result != null){
            if(result.getContents()==null){
                ...
                Intent mIntent = new Intent(getApplicationContext(), CheckList.class);
